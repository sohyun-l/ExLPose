...
class ExLPoseOC(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        #     new_name_dark = b[0]+'_'+b[1]+'_'+b[3]+'_'+b[4]+'_'+'img'+'_'+b[6]+'__'+b[10]+'_'+b[11]

        # elif 'manridang' in image_name:
        #     b = image_name.split('_')
        #     new_name_dark = b[0]+'_'+b[1]+'manridang'+'_'+b[3]+'_'+b[4]+'_'+'img'+'_'+b[6]+'__'+b[10]+'_'+b[11]


        # elif 'hwangridan' in image_name:
        #     b = image_name.split('_')
        #     new_name_dark = b[0]+'_'+b[1]+'hwangridan'+'_'+b[3]+'_'+b[4]+'_'+'img'+'_'+b[6]+'__'+b[10]+'_'+b[11]


        # elif 'bulguksa' in image_name:
        #     b = image_name.split('_')
        #     new_name_dark = b[0]+'_'+b[1]+'bulguksa'+'_'+b[3]+'_'+b[4]+'_'+'img'+'_'+b[6]+'__'+b[10]+'_'+b[11]

        # else:
        #     b = image_name.split('_')
        #     new_name_dark = b[0]+'_'+b[1]+'_'+b[2]+'_'+b[3]+'_'+'img'+'_'+b[5]+'__'+b[9]+'_'+b[10]

        # new_name_dark = bd[0]+'_'+bd[1]+'_'+bd[2]+'_'+'img'+'_'+bd[4]+'__'+bd[8]+'_'+bd[9]
        # img_path_dark = os.path.join(self.img_folder, image_name)
        # b = image_name.split('_')
        # new_name = b[0]+'_'+b[1]+'_'+b[2]+'_'+'img'+'_'+b[4]+'__'+b[8]+'_'+b[9]
        ...
        # img_dark = im_to_torch(image_dark)
        
        # rgb_mean_dark = torch.mean(img_dark, dim=[1, 2], keepdim=True)
        # scaling_dark = 0.4 / rgb_mean_dark
        # img_dark = img_dark * scaling_dark
        ...
        # rgb_mean_dark = torch.mean(image, dim=[1, 2], keepdim=True)
        # scaling_dark = 0.4 / rgb_mean_dark
        # image = image * scaling_dark
