...
class Config:
    ...
    use_GT_bbox = True
    # if use_GT_bbox:
    gt_path = os.path.join(root_dir, '256.192.model/Annotations/ExLPose-OCN','ExLPose-OC_test_A7M3_trans.json')
    ori_gt_path = os.path.join(root_dir, '256.192.model/Annotations/ExLPose-OCN','ExLPose-OC_test_A7M3.json')
