...
class TrainingData(data.Dataset):
    ...
    def augmentationCropImage(self, img, img_LL, bbox, joints=None):  
        ...
        bimg_LL = cv2.copyMakeBorder(img_LL, add, add, add, add, borderType=cv2.BORDER_CONSTANT, value=mean_value.tolist())
    ...
    def __getitem__(self, index):
        ...
        if '_3_' in image_name:
            ...
            new_name = b[0]+'_'+b[1]+'_'+b[3]+'_'+b[4]+'_'+'img'+'_'+b[6]+'__'+b[10]+'_'+b[11]

        elif 'manridang' in image_name:
            b = image_name.split('_')
            new_name = b[0]+'_'+b[1]+'manridang'+'_'+b[3]+'_'+b[4]+'_'+'img'+'_'+b[6]+'__'+b[10]+'_'+b[11]


        elif 'hwangridan' in image_name:
            b = image_name.split('_')
            new_name = b[0]+'_'+b[1]+'hwangridan'+'_'+b[3]+'_'+b[4]+'_'+'img'+'_'+b[6]+'__'+b[10]+'_'+b[11]


        elif 'bulguksa' in image_name:
            b = image_name.split('_')
            new_name = b[0]+'_'+b[1]+'bulguksa'+'_'+b[3]+'_'+b[4]+'_'+'img'+'_'+b[6]+'__'+b[10]+'_'+b[11]

        else:
            b = image_name.split('_')
            new_name = b[0]+'_'+b[1]+'_'+b[2]+'_'+b[3]+'_'+'img'+'_'+b[5]+'__'+b[9]+'_'+b[10]

        img_path = os.path.join(self.img_folder, new_name)
        ...
        img_path_LL = os.path.join(self.img_folder, 'dark/', name_LL.split('/')[1])
